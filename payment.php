...
<head>
  ...
  <title>Credit Card Form - Vue.js</title>
</head>
  ...
  <div class="wrapper" id="app">
    <div class="card-form">
      ...
      <div class="card-form__inner">
        ...
        <button class="card-form__button" name="subm_order">
          Submit
        </button>
      </form>
      </div>
...
<?php
  ...
  {
    $_SESSION['o_name'] = $_POST['name'];
    $_SESSION['o_surname'] = $_POST['surname'];
    $_SESSION['o_middle_name'] = $_POST['middle_name'];
    $_SESSION['o_passport'] = $_POST['passport'];
    $_SESSION['o_country'] = $_POST['country'];
    $_SESSION['o_room'] = $_POST['room'];
    $_SESSION['o_income'] = $_POST['income'];
    $_SESSION['o_outcome'] = $_POST['outcome'];
  }
